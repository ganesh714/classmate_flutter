...
const lightMainGradientColors = [Color(0xFF4D6BFF), Color(0xFF863AE0), Color(0xFFFF3C9E), Color(0xFFFF2673)];
...
const darkMainGradientColors = [Color(0xFF3A54CC), Color(0xFF6B2BB3), Color(0xFFCC2F7D), Color(0xFFCC1F5D)];
...
const lightMainGradient180Deg = LinearGradient(
  colors: lightMainGradientColors,
...
const darkMainGradient180Deg = LinearGradient(
  colors: darkMainGradientColors,
  stops: [0.0, 0.25, 0.7, 1.0],
);
